...
class Admin(commands.Cog):
    ...
    async def adminhelp(self, ctx):
        embed = nextcord.Embed(title=botver, description="Administrator commands for Animals! \n The administrator command prefix is `a.`. To run a command, you must begin a message with `a.`.", color=0x7289da)
        embed.add_field(name="Commands:", value="**a.shutdown** - Shuts down the bot. Aliases: **a.logout** \n**a.changestatus** - Changes the bot's Playing status. \n**a.reload** - Reloads all cogs.\n**a.serverlist** - Outputs a list of servers the bot is in to the terminal. \n**a.clearterm** - Clears the terminal. \n**a.eval** - Evaluate provided Python code.", inline=False)
